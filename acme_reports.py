...
def price():
    '''
    this price function returns a random integer between 5 and 100 to represent 
...
def product_tuple():
    ...
    results of each of the functions above creating a product tuple with a list of 
    descriptive attributes of a random product.
    '''
...
def generate_products(num_products=30):
    '''
    the generate_products function creates a list of 30 tuples that were created 
    by using a for loop and the function above that created a tuple with one list 
    of desciptive attributes of a function. returns 30 lists of attributes relating to
...
def generate_names_list(num_products=30):
    '''
    the generate_names_list functions isolates returns a just list of 30 names 
    such as the random ones found in the product_tuple above. each individual name 
    is originally created by using the function name() at the top of the page 
...
def unique_val_of_names():
    '''
    the unique_val_of_names function counts the number of unique values
    or names help inside the list of 30 randomly generated names created
    by the generate_names_list function. will result in a different number
    each time due to randomness of the generate_names_list fucntion.
    '''
...
def generate_price_list(num_products=30):
    '''
    the generate_price_list function generates a list of 30 random prices correlating with
...
def avg_price_of_prods():
    '''
    The avg_price_of_prods functiontakes takes in a newly generated list of random 
    'product' prices each time and returns a number that represents the average of all 30 numbers
...
def generate_weight_list(num_products=30):
    '''
    the generate_weight_list function generates a list of 30 random weights correlating with
    a hypothetical list of 30 random products.
    '''
    weight_list = []
    for item in range(num_products):
...
def avg_weight_of_prods():
    '''
    The avg_weight_of_prods functiontakes takes in a newly generated list of random 
    'product' weights each time and returns a number that represents the average of all 30 numbers
    in that list showing the average 'weight' of 30 randomly generated products.
    '''
...
def generate_flam_list(num_products=30):
    '''
    the generate_flam_list function generates a list of 30 random flammability
...
def avg_flam_of_prods():
      '''
    The avg_flam_of_prods function takes takes in a newly generated list of random 
    'product' flammability ratings each time and returns a number that represents
    the average of all 30 numbers in that list showing the average 'flammability rating' 
